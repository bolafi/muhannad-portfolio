...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      function bu(a10) {
        ...
        if (bt.some((a11) => b2 === `/${a11}` || b2.startsWith(`/${a11}/`))) return S.next();
        let c2 = function(a11) {
          for (let b3 of (a11.headers.get("accept-language") || "").split(",").map((a12) => a12.split(";")[0].trim().toLowerCase())) {
            let a12 = b3.split("-")[0];
            if (bt.includes(a12)) return a12;
          }
          return "en";
        }(a10), d2 = a10.nextUrl.clone();
        return d2.pathname = `/${c2}${"/" === b2 ? "" : b2}`, S.redirect(d2);
      }
      let bv = { matcher: ["/((?!_next|api|favicon.ico|robots.txt|sitemap.xml|.*\\..*).*)"] };
...
var init_edgeFunctionHandler = __esm({
  "node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js"() {
    ...
    globalThis._ROUTES = [{ "name": "src/middleware", "page": "/", "regex": ["^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next|api|favicon.ico|robots.txt|sitemap.xml|.*\\..*).*))(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$"] }];
